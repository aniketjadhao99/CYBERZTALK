...
const io = new SocketIOServer(httpServer, {
    cors: {
        origin: ['http://localhost:5000', 'http://localhost:3000', process.env.SOCKET_IO_CORS_ORIGIN || 'http://localhost:3000'],
        methods: ['GET', 'POST'],
        credentials: true
    }
});
...
app.use(cors({
    origin: ['http://localhost:5000', 'http://localhost:3000', process.env.FRONTEND_URL || 'http://localhost:3000'],
    credentials: true,
